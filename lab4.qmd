...
graph LR
    ...
    classDef logging fill:#e3f2fd,stroke:#333,stroke-width:2px,rx:6,ry:6,text-align:center,font-size:14px
    classDef monitoring fill:#f3e5f5,stroke:#333,stroke-width:2px,rx:6,ry:6,text-align:center,font-size:14px
    classDef usecase fill:#f1f8e9,stroke:#333,stroke-width:2px,rx:6,ry:6,text-align:center,font-size:14px
...
```{mermaid}
%%| fig-width: 7.5
%%{init: {'theme': 'neutral', 'look': 'handDrawn', 'themeVariables': { 'fontFamily': 'monospace', "fontSize":"20px"}}}%%
