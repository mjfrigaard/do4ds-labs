...
This requires creating/downloading a new key pair from the **AWS Console**: 

![](img/lab8-macbook-create-key-aws-console.png){width='100%' fig-align='center'}

After it's downloaded, move the `.pem` file into the `.ssh/` folder and run the following:
