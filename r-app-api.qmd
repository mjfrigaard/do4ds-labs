...
The [`_labs/lab3/R/api/mod-api.R` file](https://github.com/mjfrigaard/do4ds-labs/blob/main/_labs/lab3/R/api/mod-api.R) contains the following:
...
Now we have a working API! We'll explore the UI in the sections below. Let's launch the app.[^plumber2]

[^plumber2]: I've also created an updated [`plumber2`](plumber2.qmd) api in the `plumber.R` file. 
