...
flowchart TD
    ...
    CRAN -->|"install()<br/>update()"| RenvCache
    RenvCache -->|"renv"| ProjLib
    
    ProjLib <-->|"status()"| Lockfile
    ProjLib -->|"snapshot()"| Lockfile
    Lockfile -->|"restore()"| ProjLib
    
    %% Styling
    style Internet fill:#e1f5fe
    style Computer fill:#f3e5f5
...
flowchart TD
    ...
    %% Connections with function labels
    SysPython -->|"python -m venv"| VirtEnv
    
    PyPI -->|"pip install<br/>pip upgrade"| PipCache
    PipCache -->|"pip"| VirtEnv
    
    VirtEnv <-->|"pip list<br/>pip show"| Requirements
    VirtEnv -->|"pip freeze"| Requirements
    Requirements -->|"pip install -r"| VirtEnv
    
    %% Additional workflow arrows
    VirtEnv -.->|"source activate<br/>deactivate"| VirtEnv
