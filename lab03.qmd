...
```
1. Database connection via Python   
2. Database connection via R      
3. Python Shiny app 
4. R Shiny app 
...
The original Python App files can be found in the [`_labs/lab03/Python/` folder](https://github.com/mjfrigaard/do4ds-labs/tree/main/_labs/lab03/Python). 

```{bash}
#| code-fold: false
#| eval: false
_labs/lab03/Python/app
├── app-api.py
├── app.Rproj
├── README.md
└── requirements.txt
