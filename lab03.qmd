...
graph TB
    ...
    style PyApp fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style PyPkg fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style Driver fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style System fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style DB fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
graph TB
    ...
    J --> K
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style RApp fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style RPkgs fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style DBI fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style Driver fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style System fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style DB fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
graph LR
    ...
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style RPhil fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style PyPhil fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
graph LR
    ...
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style RApi fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
#| code-overflow: wrap
library(readr)
readr::read_lines("_labs/lab03/model-db.qmd") |> 
  base::noquote() |> 
  writeLines()
```
...
#| echo: false
library(readr)
readr::read_lines("_labs/lab03/app-api.py") |> 
  base::noquote() |> 
  writeLines()
```
...
#| code-overflow: wrap
library(readr)
readr::read_lines("_labs/lab03/py-data-load.py") |> 
  base::noquote() |> 
  writeLines()
```
...
#| echo: false
library(readr)
readr::read_lines("_labs/lab03/eda-db.qmd") |> 
  base::noquote() |> 
  writeLines()
```
...
#| code-overflow: wrap
library(readr)
readr::read_lines("_labs/lab03/r-data-load.R") |> 
  base::noquote() |> 
  writeLines()
```
