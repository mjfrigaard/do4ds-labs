...
In [lab 2](lab02.qmd), we created a Python model with `scikit-learn`, converted it into a `VetiverModel`, saved it in a `pins` board folder, then created a `VetiverAPI`:[^lab02-model-py]
...
graph TD
   ...
   subgraph Browse["<strong>Browser</strong>"]
    ...
    style Http stroke-width:1px, rx:20, ry:20, font-size:16px
    
    style FastAPI stroke-width:1px, rx:20, ry:20, font-size:16px
    style Docs stroke-width:1px, rx:20, ry:20, font-size:16px
    style Health stroke-width:1px, rx:20, ry:20, font-size:16px
    style Info stroke-width:1px, rx:20, ry:20, font-size:16px
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style T1 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style Browse fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
graph TB
    ...
    style CheckProt stroke-width:2px, rx:12, ry:12, font-size:16px
    style Mod stroke-width:2px, rx:12, ry:12, font-size:16px

    style Post stroke-width:2px, rx:12, ry:12, font-size:16px
    style GetPing stroke-width:2px, rx:12, ry:12, font-size:16px
    style GetMeta stroke-width:2px, rx:12, ry:12, font-size:16px
    style GetDocs stroke-width:2px, rx:12, ry:12, font-size:16px
    style FastAPIApp stroke-width:2px, rx:12, ry:12, font-size:16px
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
```
...
![VetiverModel & FastApi UI](img/lab3-python-vetiver-api-ui.png){fig-align="center" width="100%"}
...
graph TD
   ...
   subgraph Browse["<strong>Browser</strong>"]
    ...
    style RunApi stroke-width:2px, rx:12, ry:12, font-size:14px
    style Curl stroke-width:2px, rx:12, ry:12, font-size:14px
    style Http stroke-width:2px, rx:12, ry:12, font-size:14px

    style VerAPI stroke-width:2px, rx:12, ry:12, font-size:14px
    style Info stroke-width:2px, rx:12, ry:12, font-size:14px
    style Health stroke-width:2px, rx:12, ry:12, font-size:14px
    style Docs stroke-width:2px, rx:12, ry:12, font-size:14px
    style FastAPI stroke-width:2px, rx:12, ry:12, font-size:14px
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style T1 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style T2 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style Browse fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
graph TD
    ...
    style RunApi rx:20, ry:20, font-size:14px
    ...
    style Curl rx:20, ry:20, font-size:14px
    ...
    style RunApp rx:20, ry:20, font-size:14px
   ...
   subgraph Browse["<strong>Browser</strong>"]
    ...
    style Http rx:20, ry:20, font-size:14px

    style FastAPI font-size:14px
    style VerAPI font-size:14px
    style Docs font-size:14px
    style Health font-size:14px
    style Info font-size:14px
    style DispPred font-size:14px
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style T1 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style T2 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style T3 fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style Browse fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
```
...
graph TB
    ...
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style Py fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
sequenceDiagram
    ...
    style API fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style Vetiver fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
