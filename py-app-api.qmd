...
graph TB
    subgraph Py["Python Philosophy"]
        A["Explicit over<br>Implicit"] --> A1["Decorators to make<br>behavior clear"]
...
graph TD
	A["<code>requests.post()</code>"] --> B["All parameters<br/>in single call"]
	B --> C["<strong>Response<br>Object</strong>"]
	D["Parameter-Based"] --> E["Headers, params,<br>json (all specified together)"]
	E --> F["Single function call"]
