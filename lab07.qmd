...
|:-------------|---------------------------------------------|:-------------|
| IaaS | Provides raw computing resources like virtual servers and networking. | [Azure](Azure infrastructure as a service) |
...
The lab for this section is broken into two parts: getting started with AWS and putting the penguins data and model in S3. I've put the original files in the `original/` folder, and
