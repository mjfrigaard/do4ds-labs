...
flowchart TD
    ...
    style BL fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style DS fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
flowchart LR
    ...
    %% Style for outputs %%
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style Vet fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
flowchart LR
    ...
    %% Style for outputs %%
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style BF fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
flowchart LR
    ...
    %% Style for outputs %%
    style VetMod stroke-width:1px, rx:10, ry:10, font-size:16px
    style Post stroke-width:1px, rx:10, ry:10, font-size:16px
    style GetPing stroke-width:1px, rx:10, ry:10, font-size:16px
    style GetProto stroke-width:1px, rx:10, ry:10, font-size:16px
    style GetMeta stroke-width:1px, rx:10, ry:10, font-size:16px
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
