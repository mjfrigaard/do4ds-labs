# <em>Build R processing layer</em> {.unnumbered}
...
This document translates the contents of lab 2 in R. The source Quarto document can be found in [`_labs/lab2/R/model-vetiver-r.qmd`](https://github.com/mjfrigaard/do4ds-labs/blob/main/_labs/lab2/R/model-vetiver-r.qmd).
