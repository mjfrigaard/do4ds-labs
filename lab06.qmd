# <strong>Lab 6: Demystifying Docker</strong> {.unnumbered}
...
2. Generate a GPG key. Accept the defaults (RSA, 3072-bit) and enter a name and email when prompted:
    ...
    pub   rsa3072 2025-10-01 [SC] [expires: 2027-10-01]
          <pub-id>
    uid                      martin frigaard <mjfrigaard@pm.me>
    sub   cv25519 2026-06-28 [E] [expires: 2029-06-27]
    ```
...
4. Sign in from the Docker Desktop UI (**Sign In** button in the top-right) or from the Terminal:
    ...
    Docker will prompt for your Docker ID username and password or token and store the credentials via `pass`.
...
5. After authentication is complete in the browser, you'll see the following: 

![](img/lab6-docker-login.png){width='80%' fig-align='center'}

And docker desktop will indicate you've signed in: 

![](img/lab6-docker-logged-in.png){width='100%' fig-align='center'}
