...
flowchart TD
    ...
    style User fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style FileSys fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style ReactFile fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
...
flowchart TD
 ...
 subgraph UI["UI Rendering"]
  ...
  N --> P
    ...
    class O outcome
    classDef default fill:#F2E6C2,stroke:#2A6F77,color:#1B2A41
    style LogProc fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style UI fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
    style P fill:#d4e7e4,stroke:#2A6F77,color:#1B2A41
