...
![](img/lab04-div-session.png){width='100%' fig-align='center'}
...
![](img/lab04-div-session-token.png){width='100%' fig-align='center'}
...
![](img/lab04-predictions-wireframe.png){width='100%' fig-align='center'}
...
![](img/lab04-predictions-vals.png){width='100%' fig-align='center'}
...
![](img/lab04-predictions-pred.png){width='100%' fig-align='center'}
...
![](img/lab04-system-status-wireframe.png){width='100%' fig-align='center'}
...
![](img/lab04-api-health-check-offline.png){width='100%' fig-align='center'}

When we run the API, we can see the `ping` responds with an online status: 

![](img/lab04-api-health-check-online.png){width='100%' fig-align='center'}
...
![](img/lab04-api-recent-logs-display.png){width='100%' fig-align='center'}
...
![](img/lab04-api-recent-logs-predictions.png){width='100%' fig-align='center'}
...
![Click on image to enlarge](img/lab04-last-updated.png){width='100%' fig-align='center'}
