...
In the System Status display, I want to 1) send a `ping` to the API and return the result as **API Status**, 2) print the most recent logs from the log file we specified above in the `logger::log_appender()` function.

I'll also add a timestamp for the last time the application (in **Last updated**):
