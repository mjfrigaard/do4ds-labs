...
This lab covers how to use logging and monitoring to track events inside data science project, and what to do with logs and metrics when they are created. 

For a refresher, I've included a diagram of the Shiny App and API (using the [`plumber2` version](plumber2.qmd)) from the previous lab (i.e., the user inputs sent with the **Predict** button):
