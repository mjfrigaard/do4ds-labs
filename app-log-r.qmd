...
flowchart TD
 ...
 subgraph FileSys["File System"]
        %% A@{ shape: lin-doc, label: "<strong>shiny_app.log</strong>" }
        A[\"Log file: <strong>shiny_app.log</strong>"\]
 ...
 subgraph ReactFile["Reactive File"]
        %% B@{ shape: subproc, label: "<strong>reactiveFileReader()</strong>" }
...
flowchart TD
 ...
 subgraph UI["UI Rendering"]
  ...
  style A fill:#d08300,stroke:#d08300,color:#fff,rx:12,ry:12,text-align:center
  style H fill:#216654,stroke:#216654,color:#fff,rx:12,ry:12,text-align:center
  
  style L fill:#4ac590,stroke:#4ac590,color:#000,rx:12,ry:12
  style M fill:#4ac590,stroke:#4ac590,color:#000,rx:12,ry:12
