...
For a refresher, I've included a diagram of the Shiny App and API (using the [`plumber` version](plumber.qmd)) from the previous lab (i.e., the user inputs sent with the **Predict** button):
